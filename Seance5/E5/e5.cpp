...
// sur les rationnels on peut faire des operations ou le deuxieme operande
// est un entier; en effet celui-ci est le parametre de l'operateur est il
// converti automatiquement en un objet Ratio grace au constructeur Ratio(int)

// une operation avec le premier operande entier n'est pas acceptee, sauf si
// on ajoute une version fonction amie de l'operateur ou l'entier est en
// premier parametre et le rationnel en deuxieme
// exemple : friend Ratio operator+ (int a, const Ratio& r)
